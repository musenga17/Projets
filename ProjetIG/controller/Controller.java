...
public class Controller {
    ...
    public void createDataAndAssociate(SommetUI sui) {//associe le sommet graphique à son sommet en mémoire et inversement, pour que lorsque l'on change l'état d'un somet en mémoire par l'algo, on sait lequel colorier dans l'IG et inversement lorque l'on clike sur un sommet graphique, on sait depuis kel sommet en mémoire éxécuter l'algo
