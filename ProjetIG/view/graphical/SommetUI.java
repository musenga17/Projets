...
public abstract class SommetUI {
    ...
    LinkedList<LinkUI> listLink = new LinkedList<LinkUI>();
	...
	/*transit = new EventHandler<MouseEvent>(){
		@Override
	...
	KeyFrame keyFrameShapeInit;
	KeyFrame keyFrameNameInit;
	KeyFrame keyFrameShapeFin;
	KeyFrame keyFrameNameFin;
	Timeline timeline1 = new Timeline();
	Timeline timeline2 = new Timeline();*/
	if (validate) {
	    /*keyFrameShapeInit = new KeyFrame(Duration.ZERO,
					     new KeyValue(shape.strokeProperty(), Color.BLACK));
	    keyFrameNameInit = new KeyFrame(Duration.ZERO,
						 new KeyValue(name.fillProperty(), Color.BLACK));
	    keyFrameShapeFin = new KeyFrame(Duration.millis(4000),
						 new KeyValue(shape.strokeProperty(), Color.RED));
	    keyFrameNameFin = new KeyFrame(Duration.millis(4000),
						new KeyValue(name.fillProperty(), Color.RED));
	    timeline1.getKeyFrames().addAll(keyFrameShapeInit,keyFrameShapeFin);
	    timeline2.getKeyFrames().addAll(keyFrameNameInit,keyFrameNameFin);
	...
	shape.addEventHandler(MouseEvent.MOUSE_CLICKED, showMenu);
	//shape.addEventHandler(MouseEvent.MOUSE_CLICKED, transit);
	name.addEventHandler(MouseEvent.MOUSE_MOVED, moved);
	name.addEventHandler(MouseEvent.MOUSE_EXITED, exited);
	name.addEventHandler(MouseEvent.MOUSE_CLICKED, showMenu);
	//name.addEventHandler(MouseEvent.MOUSE_CLICKED, transit);
    }
